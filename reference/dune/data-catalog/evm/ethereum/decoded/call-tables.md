...
# Ethereum Call Tables

> On Dune, we parse all message calls and transactions made to smart contracts on the Ethereum network in their own tables.
...
<div>
  <DuneEmbed qID={3456944} vID={5809273} height={300} />
</div>
...
<div>
  <DuneEmbed qID={3456960} vID={5809303} height={300} />
</div>
